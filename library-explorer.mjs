...
import { MATRIX_SIGIL_NAMES, MATRIX_SIGN_NAMES, SIGN_PROFILES, SIGIL_PROFILES } from "./spell-grammar.mjs?v=20260809-handoff-layout-v2";
import {
  SPOILER_MAX_CHAPTER,
  clampSpoilerChapter,
  readSpoilerChapter,
...
} from "./variant-catalog.mjs?v=20260809-handoff-layout-v2";
