...
- [ ] **Step 5: Commit documentation and push**
  - Run `git add README.md docs/release-checklist.md`, commit with
    `docs: document photo recognition workflow`, and push `main`.
  - Verify the public `index.html` and `fonctionnement.html` return HTTP 200
