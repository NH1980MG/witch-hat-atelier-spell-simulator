...
export const SIGN_PROFILES = Object.freeze({
  ...
  Viseur: profile({ role: "target", operation: "crosshair", effect: "viseur", directional: true, invertible: false, confidence: "medium", mechanic: "oriente la manifestation: le cote long forme la ligne du viseur, et le cote court pointe vers la cible" }),
...
export function composeSpellRecipe({
  ...
  const manifestationPlan = synthesizeManifestation({
    ...
    geometry: normalizedGeometry || {},
    supportPlan,
    effectParameters: effectPlan.parameters,
    fidelity,
    ritualId: activeRitualId,
  });
