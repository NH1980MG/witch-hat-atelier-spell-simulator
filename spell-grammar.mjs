...
export const SIGIL_PROFILES = Object.freeze({
  Feu: profile({ family: "fire", noun: "feu", phase: "energy", defaultLabel: "flamme au sol" }),
  Eau: profile({ family: "water", noun: "eau", phase: "liquid", defaultLabel: "eau repandue" }),
  Terre: profile({ family: "earth", noun: "terre", phase: "solid", defaultLabel: "terre soulevee" }),
  Vent: profile({ family: "wind", noun: "vent", phase: "gas", defaultLabel: "courant d'air" }),
  Lumiere: profile({ family: "light", noun: "lumiere", phase: "energy", defaultLabel: "lueur au sol" }),
  Cristal: profile({ family: "crystal", noun: "cristal", phase: "solid", defaultLabel: "cristaux formes" }),
  Aeriforme: profile({ family: "air", noun: "air", phase: "gas", defaultLabel: "air defini" }),
  "Vent sous pied": profile({ family: "underfoot-wind", noun: "courant porteur", phase: "gas", defaultLabel: "portance sous le sceau" }),
  Repetition: profile({ family: "repetition", noun: "etat", phase: "meta", defaultLabel: "boucle de restitution" }),
});
