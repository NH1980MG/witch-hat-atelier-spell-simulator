...
export const SYMBOL_PATHS = Object.freeze({
  ...
  "Chat-hibou": paths(
    ...
    "M16 22 C11 22 8 19 5 19 L7 30 C12 28 16 30 19 34 M32 22 C37 22 40 19 43 19 L41 30 C36 28 32 30 29 34",
    "M19 22 L24 29 L29 22 M24 29 V43 M24 35 L17 43 M24 35 L31 43",
  ),
