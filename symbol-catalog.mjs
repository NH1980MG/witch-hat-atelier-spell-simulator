...
export const SYMBOL_PATHS = Object.freeze({
  ...
  Eau: paths(
    "M10 34 C6 27 13 16 15 12 C21 24 20 36 13 37 C12 37 11 36 10 34 Z",
    "M26 5 C16 8 34 17 23 30 C17 37 22 43 16 43",
    "M36 35 C29 27 33 13 40 15 C45 18 42 28 36 35 Z",
  ),
  Terre: paths(
  ...
  Vent: paths(
    "M27 5 C40 8 35 20 25 21 C13 22 16 31 25 29 C36 27 36 40 20 43",
    "M29 8 C22 8 22 16 29 15 M19 40 C26 40 26 32 19 33",
    "M13 17 L7 13 M13 24 H5 M13 31 L7 35 M35 17 L41 13 M35 24 H43 M35 31 L41 35",
  ),
  Lumiere: paths(
  ...
  Aeriforme: paths(
    "M27 5 C39 9 34 19 25 20 C14 21 16 31 25 29 C35 27 36 39 19 43",
    "M5 18 H16 M16 18 L10 12 M16 18 L10 24 M5 30 H16 M16 30 L10 24 M16 30 L10 36",
    "M43 18 H32 M32 18 L38 12 M32 18 L38 24 M43 30 H32 M32 30 L38 24 M32 30 L38 36",
    circle(6, 9, 1.8),
    circle(6, 39, 1.8),
    circle(42, 9, 1.8),
    circle(42, 39, 1.8),
  ...
  "Vent sous pied": paths(
    circle(24, 24, 16),
    circle(24, 24, 11),
    "M28 9 C38 15 35 27 25 24 C17 21 17 30 26 29 C33 28 34 38 23 41",
    "M20 39 C10 33 13 21 23 24 C31 27 31 18 22 19 C15 20 14 10 25 7",
  ),
  Repetition: paths(
