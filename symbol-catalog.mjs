...
const BOARD_TRACED_PATHS = Object.freeze({
  ...
  Selection: paths("M17 8 H31 V40 H17 Z", "M8 17 H40 V31 H8 Z"),
...
export const SYMBOL_GENERATED_BOARD = Object.freeze({
  ...
  Selection: "signs-perception-scope-dalle-v1.png",
...
export const SYMBOL_AUDIT = Object.freeze({
  observed: Object.freeze([
    ...
    "Arret", "Enveloppe", "Dissimulation", "Reflection", "Diamant", "Selection",
