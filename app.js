...
import { SYMBOL_AUDIT, SYMBOL_PATHS } from "./symbol-catalog.mjs?v=20260716-generated-redraw-v1";
...
const elements = [
  { name: "Feu", color: "#a94a38", rune: "FE", charge: 2, kind: "sigil", category: "Sigil", meaning: "Sigil de feu: anime, chauffe et transforme." },
  { name: "Eau", color: "#377da4", rune: "EA", charge: 0, kind: "sigil", category: "Sigil", meaning: "Sigil d'eau: coule, absorbe et transporte." },
  { name: "Terre", color: "#7b6043", rune: "TE", charge: 1, kind: "sigil", category: "Sigil", meaning: "Sigil de terre: ancre, protege et retient." },
  { name: "Vent", color: "#5c8b62", rune: "VE", charge: 0, kind: "sigil", category: "Sigil", meaning: "Sigil de vent: deplace l'air et porte les aeriformes." },
  { name: "Lumiere", color: "#d7a63e", rune: "LU", charge: 1, kind: "sigil", category: "Sigil", meaning: "Sigil de lumiere: variante du feu qui revele, guide et eclaire." },
  { name: "Cristal", color: "#7366a6", rune: "CR", charge: 1, kind: "sigil", category: "Sigil", meaning: "Sigil de cristal: durcit, structure et refracte." },
  { name: "Aeriforme", color: "#6c8f8f", rune: "AI", charge: 0, kind: "sigil", category: "Sigil", meaning: "Sigil aeriforme: cree ou indique de l'air." },
  { name: "Vent sous pied", color: "#5c8b62", rune: "VP", charge: 1, kind: "sigil", category: "Sigil", meaning: "Sigil de vent sous pied: soutien, portance et propulsion." },
  { name: "Repetition", color: "#b86b84", rune: "RE", charge: 1, kind: "sigil", category: "Sigil", meaning: "Sigil de repetition: repete ou boucle un effet." },
