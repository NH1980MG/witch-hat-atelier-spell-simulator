...
test("les quatre symboles utilisent les nouveaux traces generes", () => {
  ...
  assert.equal(SYMBOL_PATHS.Aeriforme.length, 7);
  assert.match(SYMBOL_PATHS.Aeriforme[0], /M24 17 L15 31 L33 31 Z/);
...
test("le navigateur charge la nouvelle version du catalogue partage", async () => {
  ...
  assert.match(app, /symbol-catalog\.mjs\?v=20260716-generated-redraw-v1/);
  assert.match(html, /app\.js\?v=20260716-generated-redraw-v1/);
});
